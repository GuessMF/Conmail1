...
?>
<!-- <div class="pcoded-main-container test" style="width:100%"> -->
            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/lk"><i class="feather icon-home"></i></a></li>
            ...
            <div class="col-md-12 col-xl-4">
                <div class="card support-bar overflow-hidden">
                    <div class="card-body pb-0">
                        <h2 class="m-0">350</h2>
                        <span class="text-c-blue">Запросов по заказам</span>
                        <p class="mb-3 mt-3">Общее количество решённых запросов</p>
                    </div>
