...
<body class="d-flex flex-column" style="margin-top:56px">
...
<nav class="pcoded-navbar" style="margin-top:0;height:100%">
            ...
            <div class="">
                ...
                <div class="collapse" id="nav-user-link">
                    <ul class="list-unstyled">
                        <li class="list-group-item"><a href="javascript:void(0)"><i class="feather icon-user m-r-5"></i>Посмотреть профиль</a></li>
                        <li class="list-group-item"><a href="javascript:void(0)"><i class="feather icon-settings m-r-5"></i>Настройки</a></li>
                        <li class="list-group-item"><a href="/site/logout"><i class="feather icon-log-out m-r-5"></i>Выход</a></li>
                    </ul>
                </div>
            </div>
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li><a href="/instruments/reg">Регистрация инструмента</a></li>
                        <li><a href="/sharpening">Заточка инструмента</a></li>
                        <li><a href="/coating">Нанесение покрытия</a></li>
                        <li><a href="/instruments/new">Новый иснтрумент</a></li>
                ...
                <li class="nav-item">
                    <a href="/instruments" class="nav-link "><span class="pcoded-micon"><i class="feather icon-sliders"></i></span><span class="pcoded-mtext">Инструменты</span></a>
                </li>
                <li class="nav-item pcoded-hasmenu">
